...
(paired $\Delta = -0.110$, $n = 155$, McNemar $p = 0.005$), at held-out MATH
accuracy that does not fall ($0.685$ against an untrained reference of
$0.650$). The retrained student's traces are only ${\sim}27\%$ shorter than the
...
math-CoT SFT moves an R1-distill student from acknowledgment $25.0\%$ to
$14.4\%$ (paired $p = 0.005$) at held-out MATH accuracy that does not fall,
...
planted cue from $25.0\%$ to $14.4\%$ (paired $p = 0.005$) at held-out MATH
accuracy that does not fall, and with no detectable change in the cue's pull on
